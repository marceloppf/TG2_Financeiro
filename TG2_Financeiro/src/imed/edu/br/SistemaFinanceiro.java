	...
	public static void main(String[] args) {
		...
		for (ContasReceber contasReceber : cx1.totalContasReceber) {
			System.out.println("(" + contasReceber.getDoc().getDescConta() + " - " + contasReceber.getDoc().getIdConta()
					+ "): " + "Cli: " + contasReceber.getDoc().getPessoa().getIdPessoa() + "/"
					+ contasReceber.getDoc().getPessoa().getNome() + " - " + "Doc/Vlr: "
					+ contasReceber.getDoc().getIdDoc() + "/" + contasReceber.getDoc().getVlrDoc() + " - " + "Par.Nº: "
					+ contasReceber.getNumParcelaCR() + " - " + "Vlr.Parc: " + contasReceber.getVlrParcelaCR() + " - "
					+ "Dt.Vcto: " + contasReceber.getDtVcto() + " - " + "Dt.Receb: " + contasReceber.getDtReceb()
		...
		for (ContasPagar contasPagar : cx2.totalContasPagar) {
			System.out.println("(" + contasPagar.getDoc().getDescConta() + " - " + contasPagar.getDoc().getIdConta()
					+ "): " + "Forn: " + contasPagar.getDoc().getPessoa().getIdPessoa() + "/"
					+ contasPagar.getDoc().getPessoa().getNome() + " - " + "Doc/Vlr: " + contasPagar.getDoc().getIdDoc()
					+ "/" + contasPagar.getDoc().getVlrDoc() + " - " + "Parc.Nº: " + contasPagar.getNumParcelaCP()
					+ " - " + "Vlr.Parc: " + contasPagar.getVlrParcelaCP() + " - " + "Dt.Vcto: "
					+ contasPagar.getDtVcto() + " - " + "Dt.Pgto: " + contasPagar.getDtPgto() + " - " + "Status: "
					+ contasPagar.getStCP());
		}
		...
		System.out.println("(" + cr1.getDoc().getDescConta() + " - " + cr1.getDoc().getIdConta() + "): " + "Cli: "
				+ cr1.getDoc().getPessoa().getIdPessoa() + " - " + "Doc: " + cr1.getDoc().getIdDoc() + " - "
				+ "Par.Nº: " + cr1.getNumParcelaCR() + " - " + "Vlr.Parc: " + cr1.getVlrParcelaCR() + " - "
				+ "Dt.Vcto: " + cr1.getDtVcto() + " - " + "Dt.Receb: " + cr1.getDtReceb() + " - " + "Vlr.Receb: "
				+ cr1.getVlrReceb() + " - " + "Vlr.Juro: " + cr1.getVlrJuroReceb() + " - " + "Status: "
				+ cr1.getStCR());

		System.out.println("");
		System.out.println("---->>>> Operação Pagar");
		System.out.println("(" + cp1.getDoc().getDescConta() + " - " + cp1.getDoc().getIdConta() + "): " + "Cli: "
				+ cp1.getDoc().getPessoa().getIdPessoa() + " - " + "Doc: " + cp1.getDoc().getIdDoc() + " - "
				+ "Par.Nº: " + cp1.getNumParcelaCP() + " - " + "Vlr.Parc: " + cp1.getVlrParcelaCP() + " - "
				+ "Dt.Vcto: " + cp1.getDtVcto() + " - " + "Dt.Pgto: " + cp1.getDtPgto() + " - " + "Vlr.Pgto: "
				+ cp1.getVlrPgto() + " - " + "Vlr.Desc: " + cp1.getVlrDescPgto() + " - " + "Status: " + cp1.getStCP());
	}
